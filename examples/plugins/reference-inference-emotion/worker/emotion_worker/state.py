...
between this package and the sibling yolo_worker; both now point at one
shared, dependency-free implementation (see worker-kit/README.md for
why). Kept as a same-named module, not a call-site rewrite, so every
existing `from emotion_worker.state import ...` in this package/its
