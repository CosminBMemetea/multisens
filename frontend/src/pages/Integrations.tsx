...
import { fetchConnectors, fetchPlugins } from "../api";
import type { ConnectorState, ConnectorSummary, Level, PluginStatus, PluginSummary } from "../types";
...
export function Integrations() {
  ...
  useEffect(() => {
    Promise.all([fetchPlugins(), fetchConnectors()])
      .then(([p, c]) => {
        setPlugins(p);
        setConnectors(c);
        setError(null);
